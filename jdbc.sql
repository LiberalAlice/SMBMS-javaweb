...
CREATE TABLE `smbms_bill`  (
  ...
  `providerId` int NULL DEFAULT NULL COMMENT '供应商ID',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `smbms_user`  (
  ...
  `userRole` int NULL DEFAULT NULL COMMENT '用户角色（取自角色表-角色id）',
  `createdBy` bigint NULL DEFAULT NULL COMMENT '创建者（userId）',
  `creationDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modifyBy` bigint NULL DEFAULT NULL COMMENT '更新者（userId）',
  `modifyDate` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12131 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of smbms_user
-- ----------------------------
INSERT INTO `smbms_user` VALUES (1, 'admin', '系统管理员', '123', 1, '1997-01-01', '15200981234', '湖南省衡阳市蒸湘区南华大学', 1, 1, '2019-04-07 10:15:55', NULL, NULL);
INSERT INTO `smbms_user` VALUES (6, 'zhanghua', '张华', '123', 1, '1983-06-15', '13544561111', '北京市海淀区学院路61号', 3, 1, '2013-02-11 10:51:17', NULL, NULL);
INSERT INTO `smbms_user` VALUES (7, 'wangyang', '王洋', '123456777', 2, '1982-12-31', '13444561124', '北京市海淀区西二旗辉煌国际16层', 3, 1, '2014-06-11 19:09:07', NULL, NULL);
...
INSERT INTO `smbms_user` VALUES (15, 'silver', '冷静', 'aaa', 1, '1980-06-15', '123123', 'gdfgd', 1, NULL, NULL, NULL, NULL);
INSERT INTO `smbms_user` VALUES (16, 'gold', '杨兴', '1231231', 1, '2022-05-18', '15271807534', '武汉市洪山区南李路28号附1号', 2, NULL, NULL, NULL, NULL);
INSERT INTO `smbms_user` VALUES (17, 'diamond', '紫水', '123123123', 1, '2022-05-10', '15271807534', '武汉市洪山区南李路28号附1号', 3, NULL, NULL, NULL, NULL);
INSERT INTO `smbms_user` VALUES (18, 'permeate', '阙宇', '1231231', 1, '2022-05-16', '15271807534', '武汉市洪山区南李路28号附1号', 1, NULL, NULL, NULL, NULL);
INSERT INTO `smbms_user` VALUES (19, 'zhanghuaasdas11', 'asdasd', '1231231', 1, '2022-05-09', '15271807534', '武汉市洪山区南李路28号附1号', 1, NULL, NULL, NULL, NULL);
